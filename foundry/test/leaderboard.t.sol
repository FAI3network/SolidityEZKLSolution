...
//     );
//     event MetricsRun(IVerifier indexed verifier, int256[] metrics);
...
//     bool[3][] public I_VARS;

//     /* Tests */
//     function setUp() public {
//         // deploy lib metrics
//         metricsContract = address(Metrics);
//         lb = new Leaderboard(address(metricsContract));
...
//         vm.expectEmit();
//         emit ModelRegistered(verifier, address(this), MODEL_URI);
...
//             address(this)
//         );
//         bytes32 res = lb.verifyInference(verifier, proof, instances, I_VARS); // verify inference
...
//         vm.expectRevert(abi.encodeWithSelector(ModelNotRegistered.selector));
//         lb.verifyInference(verifier, proof, instances, I_VARS); // verify inference
//     }
